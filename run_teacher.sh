...
for CKPT_PATH in "${CHECKPOINTS[@]}"; do
    ...
    COMMANDS+=("python evaluate_navi_correspondence.py backbone=custom_dinov2_b14 backbone.teacher_checkpoint=${CKPT_PATH}/teacher_checkpoint.pth")
    ...
    COMMANDS+=("python evaluate_scannet_correspondence.py backbone=custom_dinov2_b14 backbone.teacher_checkpoint=${CKPT_PATH}/teacher_checkpoint.pth")
